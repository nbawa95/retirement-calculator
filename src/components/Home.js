    ...
    render() {
      ...
      return (
          <div style={{textAlign: "left", padding: "10%"}}>
            ...
            {this.state.showCurrentSavings ? <TextField id="standard-basic" label="current savings" style={{paddingBottom: "20px"}} onKeyDown={this.handleKeyDown} /> : null }
            ...
            : null }
            {this.state.showCompoundRate ? <TextField id="standard-basic" label="compound rate" style={{paddingBottom: "20px"}} onKeyDown={this.handleKeyDownCompoundRate} /> : null }
            {this.state.renderExpectedSavings ?
              ...
              : null }
            {this.state.showExpectedSavings ? <TextField id="standard-basic" label="expected savings" style={{paddingBottom: "20px"}} onKeyDown={this.handleKeyDownExpectedSavings}/> : null }
            {this.state.renderDesiredRetirementAmount ?
              ...
              : null }
            {this.state.showDesiredRetirementAmount ? <TextField id="standard-basic" label="yearly retirement" style={{paddingBottom: "20px"}} onKeyDown={this.handleKeyDownDesiredRetirementAmount}/> : null }
